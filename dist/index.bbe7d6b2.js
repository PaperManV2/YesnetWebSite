...
if (darkModeEnabled) document.body.classList.add("nightMode", "disable-transition");
checkbox.checked = checkboxChecked;
const toggleDarkMode = ()=>{
    document.body.classList.toggle("nightMode");
    localStorage.setItem(darkModeKey, document.body.classList.contains("nightMode"));
...
if (checkbox.classList.contains("toggled-once") && darkModeEnabled) {
    ...
    toggleThumb.classList.add("toggled-once");
} else if (checkbox.checked) toggleThumb.style.transform = "translateX(22px)";
else toggleThumb.style.transform = "translateX(0)";
